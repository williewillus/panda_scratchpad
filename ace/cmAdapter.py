...
#To run : python cmAdapter.py -b src/tests/generic_039/base_test.cpp  -t src/tests/generic_039/generic_039 -p src/tests/generic_039
import os
import re
import sys
import stat
...
def build_parser():
    ...
    # crash monkey args
    parser.add_argument('--target_path', '-p', default='../src/tests/', help='Directory to save the generated test files')
...
def main():
    ...
    # base_test = '../src/tests/base_test.cpp'
